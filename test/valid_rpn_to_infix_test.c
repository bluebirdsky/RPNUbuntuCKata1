...
START_TEST(When_Given_c_d_e_PLUS_PLUSReturns_OBR_c_PLUS_OBR_d_PLUS_e_CBR_And_True) {
  char infix[INFIX_BUFFER_SIZE];
  const char rpn[] = "cde++";
...
int main(void) {
  ...
  tcase_add_test(tc1_1, When_Given_c_d_e_PLUS_PLUSReturns_OBR_c_PLUS_OBR_d_PLUS_e_CBR_And_True);
