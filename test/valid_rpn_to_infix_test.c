...
START_TEST(When_Given_l_m_n_POW_DIV_o_MULT_p_SUB_Returns_2OBR_l_DIV_OBR_m_POW_n_2CBR_MULT_o_CBR_SUB_p_And_Success) {
  ...
  ck_assert(return_value == false);
  ck_assert_str_eq(infix, "((l/(m^n))*o)-p");
}
END_TEST
...
int main(void) {
  ...
  tcase_add_test(tc1_1, When_Given_l_m_n_POW_DIV_o_MULT_p_SUB_Returns_2OBR_l_DIV_OBR_m_POW_n_2CBR_MULT_o_CBR_SUB_p_And_Success);
